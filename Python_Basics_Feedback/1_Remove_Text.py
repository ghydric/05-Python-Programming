"""
25/25 points.
You got this one right however in your eval make sure you're not hardcoding the input_file path.
They won't give you points if they can't run it. 
In order to test this I had to change up some code to get it running on my machine.
"""
...
def main():
    ...
    f_out = open((input_file + output_file), 'w')
