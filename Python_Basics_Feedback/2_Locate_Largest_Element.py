...
Close on this one. Doesn't locate the largest element and then errors out but you are 
    setting up your 2d list correctly.
You can solve this by just doing 1 outer loop and 1 nested loop. You're trying with 
    1 outer and 2 nested loops here
"""
